...
//   return isValidURL("https://aws.amazon.com/blogs/database/cost-effective-bulk-processing-with-amazon-dynamodb/?trk=1921da0f-a305-430a-9bf6-a72d94007afa&sc_channel=el").then(data => {
//     expect(data.status == 404).toBe(true);
//   });
// });

test('Valid Amazon blog post URL', async () => {
  // Call the async function and await the result
  const result = await isValidURL("https://aws.amazon.com/blogs/database/cost-effective-bulk-processing-with-amazon-dynamodb/?trk=1921da0f-a305-430a-9bf6-a72d94007afa&sc_channel=el");
  // Assertion
  expect(result).toBeTrue();
});

//test for checking the url input - blog post url
// test('Valid Amazon blog post URL 2', () => {
//   expect(isValidURL('https://aws.amazon.com/blogs/database/cost-effective-bulk-processing-with-amazon-dynamodb/?trk=1921da0f-a305-430a-9bf6-a72d94007afa&sc_channel=el')).toBe(true);
// });
...
//   expect(isValidURL('https://aws.amazon.com/blogs/aws/doesnotexist')).toBe(false);
// });
